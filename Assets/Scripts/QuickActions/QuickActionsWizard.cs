...
using ImmerisvePiano.Interaction.Editor;
...
namespace ImmersivePiano.Interaction.Editor.QuickActions
{
    internal abstract class QuickActionsWizard : EditorWindow
    {
        ...
        protected const string MENU_FOLDER = "GameObject/Poke Quick Actions/";
        ...
        /// <summary>
        /// Get all the meshes from the parent of the object, otherwise just take the object mesh
        /// </summary>
        //public Mesh[] GetAllMeshes(GameObject target)
        //{
        //    Mesh[] result = new Mesh[] { null };
        //    GameObject parent = target.transform.parent.gameObject;
        //    foreach(Transform child in parent.transform)
        //    {
        //        if (child != null && child.GetComponent<MeshFilter>() != null)
        //        {
        //            Mesh temp = child.GetComponent<MeshFilter>().mesh; 
